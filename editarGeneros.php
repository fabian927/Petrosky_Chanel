...
<body>
    ...
    <section class="contenedor_editar">
        <section class="contenedor_formulario">
            <form action="funcionalidadEditarGeneros.php" method="post">
                ...
                <div class="contenedor_form_header">
                    <h2 class="form_header">Editar Generos</h2>
                </div>
                ...
                <?php 
                    ...
                    <div class="contenedor_input">
                        <label for="Activo">Activo</label> <?php
                                $Activo = $registro["Activo"];
                                echo '<input id="Activo" value="'.$Activo.'" name="Activo" type="checkbox">';
                        ?>
