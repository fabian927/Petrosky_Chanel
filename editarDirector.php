...
<body>
    ...
    <section class="contenedor_editar">
        <section class="contenedor_formulario">
            <form action="funcionalidadEditarDirector.php" method="post">

                    <?php
                        require("conexion.php");
                        $conn = conectar();
                        $id = $_GET["id"];
                        $query = "select * from directores where id=$id";
                ...
                <?php 
                    ...
                    <div class="contenedor_input">
                        ...
                        <?php
                                ...
                                echo '<input id="url_foto" value="'.$url_foto.'" name="url_foto" type="text">';
                        ?>
